...
import com.example.tmdbmovieapi.databinding.ActivityTvSerialDetailsBinding
import com.squareup.picasso.Picasso

class TvSerialDetailsActivity : AppCompatActivity() {
    lateinit var binding :ActivityTvSerialDetailsBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
       binding = DataBindingUtil.setContentView(this,R.layout.activity_tv_serial_details)
